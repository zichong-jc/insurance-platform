...
public class PingAnSync implements InsuranceSync {
    ...
    public String getCompanyCode() {
        return CompanyType.PING_AN.getCode();
    }

    @Override
    public String getCompanyName() {
        return CompanyType.PING_AN.getDescription();
    }
    ...
    private List<String> fetchProductUrls() {
        return List.of(
                "https://www.pingan.com/product1.pdf",
                "https://www.pingan.com/product2.pdf",
                "https://www.pingan.com/product3.pdf"
        );
    }

    private String getProductUrl(Long productId) {
        return "https://www.pingan.com/product" + productId + ".pdf";
    }
