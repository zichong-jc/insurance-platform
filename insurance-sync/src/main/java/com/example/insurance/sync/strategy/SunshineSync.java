...
public class SunshineSync implements InsuranceSync {
    ...
    public CompanyType getCompanyType() {
        return CompanyType.SUNSHINE;
    }

    @Override
    public String getCompanyCode() {
        return CompanyType.SUNSHINE.getCode();
    }

    @Override
    public String getCompanyName() {
        return CompanyType.SUNSHINE.getDescription();
    }

    @Override
    public SyncLog syncAllProducts() {
        log.info("Starting sync for Sunshine insurance products");
        ...
        try {
            ...
            log.error("Sync failed for Sunshine", e);
    ...
    public SyncLog syncProduct(Long productId) {
        log.info("Syncing specific product: {} for Sunshine", productId);
        Instant startTime = Instant.now();
    ...
    private List<String> fetchProductUrls() {
        return List.of(
                "https://www.sunshine.com/product1.pdf",
                "https://www.sunshine.com/product2.pdf",
                "https://www.sunshine.com/product3.pdf"
        );
    }

    private String getProductUrl(Long productId) {
        return "https://www.sunshine.com/product" + productId + ".pdf";
    }
